...
class AdminCog(Cog):
    ...
    def __init__(self, clipster: Clipster, bot: Bot, *args, **kwargs):
    ...
    async def reload_modules(self, ctx: Context):
        ...
        count = await self.clipster.module_manager.reload_registered_modules()
        total = len(self.clipster.module_manager.modules)
